...
static apt_bool_t smartspeech_mrcp_recognition_engine_open(mrcp_engine_t *mrcp_engine);
static apt_bool_t smartspeech_mrcp_recognition_engine_destroy(mrcp_engine_t *mrcp_engine);
...
apt_bool_t smartspeech_mrcp_recognition_engine_destroy(mrcp_engine_t *mrcp_engine) {
  auto *smartspeech_recognition_engine = static_cast<smartspeech::mrcp::recognition::engine *>(mrcp_engine->obj);

  delete smartspeech_recognition_engine;
...
mrcp_engine_channel_t *smartspeech_mrcp_recognition_channel_create(mrcp_engine_t *mrcp_engine, apr_pool_t *pool) {
  ...
  return smartspeech_recognition_channel->mrcp_channel();
}
