"""
Dependency to sofia-sip, a SIP libarary
"""
...
def load_sofia_sip():
    ...
    maybe(
        http_archive,
        name = "sofia-sip",
        url = "https://github.com/unispeech/sofia-sip/archive/refs/heads/uni.tar.gz",
        # sha256 = "48e9dbf45ae3fdc7b491259ffb6ccf7d63049ffacbc1c0977cced095e4c2d5a2",
        strip_prefix = "sofia-sip-uni",
        build_file = "//third_party/sofia-sip:sofia-sip.BUILD",
    )
